...
export const projects = [
  ...
  },
  {
    ...
    longDescription:
      "The E-commerce Store represents a cutting-edge online platform leveraging modern technology to deliver a seamless shopping experience. This robust website incorporates advanced features such as comprehensive product listings, a user-friendly shopping cart, and a secure checkout process. Through the integration of React, Redux, Node.js, Express, and MongoDB, it ensures reliability, scalability, and security, catering to the needs of both customers and administrators while maintaining a high standard of performance.",
    imageUrl: image2,
